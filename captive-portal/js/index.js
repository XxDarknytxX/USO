...
const IndexObj = {
  ...
  onLogin() {
    ...
    paramObj = {
      ...
      clientMac: this._getParamVal("clientMac") || this._getParamVal("usermac") || this._getParamVal("mac"),
      ...paramObj,
    };
    ...
    $.post({
      ...
      success: function (response) {
        ...
        if (response.success) {
          // Store voucher code so the post-auth status page can pick it up
          try {
            if (paramObj.account) {
              localStorage.setItem('uso_voucher_code', paramObj.account.trim());
            }
